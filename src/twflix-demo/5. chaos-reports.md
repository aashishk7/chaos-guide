...
chaos run twflix/chaos/network-rollback.yaml  --journal-path journal-network-rollback.json
...
chaos run twflix/chaos/network.yaml  --journal-path journal-network.json
